...
function renderDiagram(result) {
  ...
  target.append(
    ...
    svg("text", { x: Math.max(12, boatSternX), y: bowPointY - 10, fill: "#17212b", "font-size": 13, "font-weight": 700 }, [document.createTextNode(`Bow roller ${fmt(input.bowHeight, 1, " m")} above water`)]),
